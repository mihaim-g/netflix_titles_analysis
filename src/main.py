...
from reccomendations.recommend_titles import RecommendTitles
...
if __name__ == '__main__':
    ...
    with CreateSparkSession(credentials, env.env, env.s3_endpoint) as spark:
        ...
        recommendations = RecommendTitles(ratings.ratings_df)
        recommendations.recommendations_df.show(10)
